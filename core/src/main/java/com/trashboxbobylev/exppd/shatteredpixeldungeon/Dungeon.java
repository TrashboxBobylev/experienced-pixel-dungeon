...
import com.trashboxbobylev.exppd.shatteredpixeldungeon.levels.*;
...
public class Dungeon {
	...
	public static Level newLevel() {
		...
		case 26:
			...
			break;
        case 27:
            level = new SewerSuperLevel();
            break;
            case 28:
                level = new PrisonSuperLevel();
                break;
            case 29:
                level = new CavesSuperLevel();
                break;
            case 30:
                level = new CitySuperLevel();
                break;
            case 31:
                level = new HallsSuperBossLevel();
                break;
		default:
