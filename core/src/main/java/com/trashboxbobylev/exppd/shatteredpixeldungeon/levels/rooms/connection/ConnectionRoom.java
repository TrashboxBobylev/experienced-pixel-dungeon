...
package com.trashboxbobylev.exppd.shatteredpixeldungeon.levels.rooms.connection;
...
public abstract class ConnectionRoom extends Room {
	...
	static {
		...
		chances[4] =  chances[3] = chances[2] = chances[27] = chances[1];
		chances[5] =  new float[]{18, 0,    0, 0,       7, 0};
		
		chances[6] =  new float[]{0, 0,     22, 3,      0, 0};
		chances[10] = chances[9] = chances[8] = chances[7] = chances[28]= chances[6];
		
		chances[11] = new float[]{12, 0,    0, 5,       5, 3};
		chances[15] = chances[14] = chances[13] = chances[12] = chances[29] = chances[11];
		
		chances[16] = new float[]{0, 0,     18, 3,      3, 1};
		chances[20] = chances[19] = chances[18] = chances[17] = chances[30]= chances[16];
		
		chances[21] = chances[5];
		
		chances[22] = new float[]{15, 4,    0, 2,       3, 2};
		chances[26] = chances[25] = chances[24] = chances[23] = chances[31]= chances[22];
	}
