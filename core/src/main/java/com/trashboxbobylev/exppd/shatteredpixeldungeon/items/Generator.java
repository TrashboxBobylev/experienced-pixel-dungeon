...
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.artifacts.ChaliceOfBlood;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.artifacts.CloakOfShadows;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.artifacts.DriedRose;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.artifacts.EtherealChains;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.artifacts.HornOfPlenty;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.artifacts.LloydsBeacon;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.artifacts.MasterThievesArmband;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.artifacts.SandalsOfNature;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.artifacts.TalismanOfForesight;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.artifacts.TimekeepersHourglass;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.artifacts.UnstableSpellbook;
...
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.food.Pasty;
...
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.potions.PotionOfHaste;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.potions.PotionOfHealing;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.potions.PotionOfInvisibility;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.potions.PotionOfLevitation;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.potions.PotionOfLiquidFlame;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.potions.PotionOfMindVision;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.potions.PotionOfParalyticGas;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.potions.PotionOfPurity;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.potions.PotionOfStrength;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.potions.PotionOfToxicGas;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.rings.Ring;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.rings.RingOfAccuracy;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.rings.RingOfElements;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.rings.RingOfEnergy;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.rings.RingOfEvasion;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.rings.RingOfForce;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.rings.RingOfFuror;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.rings.RingOfHaste;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.rings.RingOfMight;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.rings.RingOfSharpshooting;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.rings.RingOfTenacity;
...
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.scrolls.ScrollOfMirrorImage;
...
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.stones.StoneOfAffection;
...
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.stones.StoneOfBlast;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.stones.StoneOfBlink;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.stones.StoneOfClairvoyance;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.stones.StoneOfDeepenedSleep;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.stones.StoneOfDisarming;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.stones.StoneOfEnchantment;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.stones.StoneOfFlock;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.stones.StoneOfIntuition;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.stones.StoneOfShock;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.wands.Wand;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.wands.WandOfBlastWave;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.wands.WandOfCorrosion;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.wands.WandOfCorruption;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.wands.WandOfDisintegration;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.wands.WandOfFireblast;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.wands.WandOfFrost;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.wands.WandOfLightning;
...
import com.trashboxbobylev.exppd.shatteredpixeldungeon.plants.Earthroot;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.plants.Fadeleaf;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.plants.Firebloom;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.plants.Icecap;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.plants.Plant;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.plants.Rotberry;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.plants.Sorrowmoss;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.plants.Starflower;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.plants.Stormvine;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.plants.Sungrass;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.plants.Swiftthistle;
