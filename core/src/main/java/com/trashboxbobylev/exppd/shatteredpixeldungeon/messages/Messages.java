...
package com.trashboxbobylev.exppd.shatteredpixeldungeon.messages;
...
public class Messages {
	...
	private static String[] prop_files = new String[]{
			"com.trashboxbobylev.exppd.shatteredpixeldungeon.messages.actors.actors",
			"com.trashboxbobylev.exppd.shatteredpixeldungeon.messages.items.items",
			"com.trashboxbobylev.exppd.shatteredpixeldungeon.messages.journal.journal",
			"com.trashboxbobylev.exppd.shatteredpixeldungeon.messages.levels.levels",
			"com.trashboxbobylev.exppd.shatteredpixeldungeon.messages.plants.plants",
			"com.trashboxbobylev.exppd.shatteredpixeldungeon.messages.scenes.scenes",
			"com.trashboxbobylev.exppd.shatteredpixeldungeon.messages.ui.ui",
			"com.trashboxbobylev.exppd.shatteredpixeldungeon.messages.windows.windows",
			"com.trashboxbobylev.exppd.shatteredpixeldungeon.messages.misc.misc"
	};
	...
	public static String get(Class c, String k, Object...args){
		String key;
		if (c != null){
			key = c.getName().replace("com.trashboxbobylev.exppd.shatteredpixeldungeon.", "");
			key += "." + k;
		} else
			key = k;
