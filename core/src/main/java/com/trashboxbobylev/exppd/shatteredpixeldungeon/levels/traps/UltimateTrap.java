...
package com.trashboxbobylev.exppd.shatteredpixeldungeon.levels.traps;
...
public class UltimateTrap extends Trap {
								...
								public void call() {
									...
									if (finalTarget == Dungeon.hero) {
										...
										if (!finalTarget.isAlive()) {
											Dungeon.fail( UltimateTrap.class );
											GLog.n( Messages.get(UltimateTrap.class, "ondeath") );
										}
									} else {
