...
package com.trashboxbobylev.exppd.shatteredpixeldungeon.scenes;
...
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.Stylus;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.Torch;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.armor.PlateArmor;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.armor.curses.Bulk;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.artifacts.*;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.items.food.Blandfruit;
...
import com.trashboxbobylev.exppd.shatteredpixeldungeon.ui.*;
import com.trashboxbobylev.exppd.shatteredpixeldungeon.windows.WndTitledMessage;
...
public class ChangesScene extends PixelScene {
	...
	public void create() {
        ...
        changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.EXOTIC_LAGUZ, null), Messages.get(ScrollOfPolymorph.class, "name"),
                "The scroll of polymorph now doesn't crash the game."));

        changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.SPIRIT_BOW, null), Messages.get(SpiritBow.class, "name"),
                "If player have 200+ level, spirit bow's max damage will be multiplied by 40x."));

        changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.MAGES_STAFF, null), Messages.get(MagesStaff.class, "name"),
                "If player have 200+ level, mage's staff's max damage will be multiplied by 95x."));
        ...
        changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.RING_AMETHYST, null), Messages.get(RingOfWealth.class, "name"),
                "Ring of Wealth have caused a bunch of issues, that I'm fixed:\n\n" +
                                        "_-_ Now capped at +50.\n\n"+
                                        "_-_ Doesn't drop the any equipment now, get them from skeletons and imps.\n\n"+
                                        "_-_ All equipment were replaced by amazing frozen carpaccio and bombs."));

        changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.ARTIFACT_BELT, null), Messages.get(ExpBelt.class, "name"),
                "The experience band have been improved again.\n\n"+
                        "_-_ Increased EXP gain after +50."));

        changes.addButton( new ChangeButton( Icons.get(Icons.DEPTH), "New Chapter Issues",
                "The bestiary and generator for new depths now exists."));

        changes.addButton(new ChangeButton(new Image(Assets.KEEPER, 0, 0, 16, 16), "Shop Adjustments",
                "Shopkeepers now provide random armor, weapon and missile."));

        changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.EXOTIC_LAGUZ, null), Messages.get(ScrollOfPolymorph.class, "name"),
                "The scroll of polymorph have been reworked.\n\n"+
                        "_-_ Spawns ultimate mimics instead of sheeps, replaces with mimics all enemies on floor."));

        changes = new ChangeInfo("v1.1", false, null);
        changes.hardlight( Window.TITLE_COLOR );
        infos.add(changes);

        changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.ARTIFACT_BELT, null), Messages.get(ExpBelt.class, "name"),
                "The experience band have been improved.\n\n"+
                        "_-_ now shows left EXP before upgrade.\n" +
                        "_-_ now properly shows level."));

        changes.addButton(new ChangeButton(new Image(Assets.BUFFS_LARGE, 80, 32, 16, 16), "Experience Gaining",
                "Now amplified by band in any possible case.") );

        changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.RING_AMETHYST, null), Messages.get(RingOfWealth.class, "name"),
                "Ring of Wealth were majorly buffed:\n" +
                        "_-_ Special wealth drops can now provide Scrolls of Upgrade.\n" +
                        "_-_ The ring of wealth now awards a more better items in general.\n" +
                        "_-_ Slowly upgrades with experience gaining.\n" +
                        "_-_ Wraiths and minion enemies now have a chance to generate wealth items.\n" +
                        "_-_ Can be found as +1 on floor 1."));

        changes.addButton( new ChangeButton( Icons.get(Icons.DEPTH), "Dungeon New Chapter!",
                "The new depths of the dungeon have been opened!\n\n" +
                        "_-_ 5 additional depths were added.\n\n" +
                        "_-_ They hold a lot more loot that regular depths.\n\n" +
                        "_-_ There are also a LOT of monsters!\n\n" +
                        "_-_ You will encounter a five Yogs!\n\n" +
                        "_-_ It's also are very big!\n\n\n" +
                        "You can find entrance to this stage on Amulet's pedestal."));
        ...
        changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.ARTIFACT_BELT, null), Messages.get(ExpBelt.class, "name"),
                "The new artifact have been added!\n\n"+
                "This artifact will increase experience gaining.\n" +
                "You can find it on floor 1."));

        changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.POTION_CRIMSON, null), "Max Level Cap",
                "The experience level caps have been broken. Have fun!"));
